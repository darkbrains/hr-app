...
const translations = {
    ...
    ru: {
        ...
        {
            text: "Опишите случай, когда вы потерпели неудачу в этой роли, и урок, который вы извлекли.",
            options: [
                { text: "Я ни разу не провалился в своей роли.", value: "1" },
                { text: "Неудача произошла из-за плохого управления временем, и с тех пор я улучшил свои навыки расстановки приоритетов.", value: "2" },
                { text: "Неудача произошла из-за недопонимания, и я работал над улучшением своих коммуникативных навыков.", value: "3" },
        ...
        {
            text: "Какой последний проект вы возглавляли и каков был его результат?",
            options: [
    ...
    hy: {
        ...
        },
        {
            ...
            options: [
                ...
                { text: "Պլանավորելով և առաջնահերթ առաջադրանքները", value: "4" }
            ]
        },
        {
            text: "Ո՞ր արդյունքն է առավել մեծացնում ձեր մոտիվացիան աշխատանքի մեջ:",
            options: [
                { text: "Հատուկ նպատակների ձեռքբերում", value: "4" },
                { text: "Աջակցել և օգնել գործընկերներին", value: "3" },
                { text: "Ստանալով ճանաչում և շոշափելի պարգևներ", value: "1" },
        ...
        },
        {
            ...
            options: [
                { text: "Ես պայքարում եմ առաջնահերթությունների հետ", value: "1" },
                { text: "Ըստ առաջադրանքի կարևորության", value: "3" },
                { text: "Վերահսկիչի ուղղության հիման վրա", value: "2" },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "Ես դա կառուցողականորեն եմ ընդունում՝ բարելավելու համար", value: "4" },
                { text: "Ես դժվարանում եմ ընդունել", value: "2" },
                { text: "Դա կախված է նրանից, թե ումից է այն գալիս", value: "3" }
            ]
        },
        {
        ...
        },
        {
            ...
            options: [
                { text: "Պատվիրակելու երկմտանք", value: "3" },
                { text: "Չափից շատ աշխատանք ստանձնելը", value: "2" },
                { text: "Անհամբերություն", value: "4" },
        ...
        {
            text: "Նկարագրեք մի դեպք, երբ դուք ձախողվեցիք այս դերում, և ձեր քաղած դասը:",
            options: [
                { text: "Ես երբեք չեմ ձախողվել իմ դերում.", value: "1" },
                { text: "Անհաջողությունը պայմանավորված էր ժամանակի վատ կառավարմամբ, և ես դրանից հետո բարելավել եմ առաջնահերթությունների իմ հմտությունները:", value: "2" },
                { text: "Անհաջողությունը սխալ հաղորդակցման պատճառով էր, և ես աշխատել եմ իմ հաղորդակցման հմտությունները բարելավելու վրա:", value: "3" },
        ...
        },
        {
            ...
            options: [
                { text: "Առաջնորդական պաշտոնի անցնելու համար", value: "4" },
        ...
        {
            text: "Ինչպե՞ս եք արդիանում ոլորտի միտումներին:",
            options: [
                { text: "Ես դժվարանում եմ հետ պահել", value: "1" },
                { text: "Աշխատաժողովների և կոնֆերանսների մասնակցություն", value: "3" },
                { text: "Մասնագիտական ամսագրերի ընթերցում", value: "4" },
                { text: "Ցանցային կապ ոլորտի մասնագետների հետ", value: "2" }
            ]
        },
        {
            text: "Ինչպե՞ս եք գնահատում հաջողությունը:",
            options: [
                { text: "Հետադարձ կապ ստանալով հասակակիցներից և ղեկավարներից", value: "2" },
        ...
        {
            text: "Ի՞նչ արդյունք եք ունեցել ձեր վերջին նածագծում:",
            options: [
        ...
        {
            text: "Ինչպե՞ս եք վերաբերվում իրավիճակին, երբ պատասխանը չգիտեք:",
            options: [
                { text: "Ուսումնասիրել, մինչև ես գտնեմ պատասխանը", value: "4" },
                { text: "Խուսափել իրավիճակից", value: "1" },
                { text: "Հարցրեք գործընկերոջը կամ ղեկավարին առաջնորդության համար", value: "3" },
                { text: "Օգտագործեք իմ լավագույն դատողությունը և շարունակել", value: "2" }
            ]
        },
        {
            text: "Ինչպե՞ս եք մոտենում նոր հմտություն կամ տեխնոլոգիա սովորելուն:",
            options: [
                { text: "Զգուշորեն, բայց փորձելու պատրաստակամությամբ", value: "3" },
                { text: "Դժկամությամբ, միայն անհրաժեշտության դեպքում", value: "2" },
                { text: "Ես նախընտրում եմ մնալ այն, ինչ գիտեմ", value: "1" },
        ...
        },
        {
            ...
            options: [
                ...
                { text: "Առաջնահերթ առաջադրանքներ և արդյունավետ աշխատանք", value: "4" },
                { text: "Երկար ժամեր աշխատել է վերջնաժամկետը պահպանելու համար", value: "3" },
        ...
        },
        {
            ...
            options: [
                { text: "Մրցակցային մարտահրավերներ", value: "4" },
                { text: "Համագործակցային թիմային աշխատանք", value: "3" },
                { text: "Անկախ աշխատել", value: "1" },
                { text: "Աշխատանքի ճկուն պայմանավորվածություններ", value: "2" }
            ]
        }
        ],
        errors: {
            answerRequired: 'Պատասխան է պահանջվում։'
        },
        buttonNext: 'Հաջորդը',
        buttonPrev: 'Նախորդը',
